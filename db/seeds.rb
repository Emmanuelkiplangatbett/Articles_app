...
Profile.create([
  {bio:Faker::Lorem.sentence(word_count: 30), image_url:Faker::LoremFlickr.image(size: "50x60"), linkedin:"https://linkedin.com/faker-ruby/manu", github:"https://github.com/faker-ruby/manu", twitter:"https://twitter.com/faker-ruby/manu", dev_id:6},
  {bio:Faker::Lorem.sentence(word_count: 10), image_url:Faker::LoremFlickr.image(size: "50x60"), linkedin:"https://linkedin.com/faker-ruby/bett", github:"https://github.com/faker-ruby/bett", twitter:"https://twitter.com/faker-ruby/bett", dev_id:10},
  ...
  {bio:Faker::Lorem.sentence(word_count: 10), image_url:Faker::LoremFlickr.image(size: "50x60"), linkedin:"https://linkedin.com/faker-ruby/trevor", github:"https://github.com/faker-ruby/trevor", twitter:"https://twitter.com/faker-ruby/trevor", dev_id:11}
...
Subscriber.create! ([
    ...
    {username:Faker::Internet.username,password_digest:Faker::Internet.password,email:Faker::Internet.email},
    {username:Faker::Internet.username,password_digest:Faker::Internet.password,email:Faker::Internet.email},
    {username:"Propesa",password_digest:"Propesa123",email:Faker::Internet.email}
